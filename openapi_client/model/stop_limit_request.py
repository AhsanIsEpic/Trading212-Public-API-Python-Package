...
class StopLimitRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["limitPrice", "quantity", "stopPrice", "ticker", "timeValidity", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["limitPrice", "quantity", "stopPrice", "ticker", "timeValidity", ], str]):
