...
class MarketRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["quantity", "ticker", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["quantity", "ticker", ], str]):
