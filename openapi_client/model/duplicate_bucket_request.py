...
class DuplicateBucketRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["icon", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["icon", "name", ], str]):
