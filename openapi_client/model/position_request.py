...
class PositionRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ticker", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ticker", ], str]):
