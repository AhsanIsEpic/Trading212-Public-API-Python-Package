...
# body param
SchemaForRequestBodyApplicationJson = MarketRequest


request_body_market_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _place_market_order_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_market_request.serialize(body, content_type)
...
class PlaceMarketOrder(BaseApi):
    ...
    def place_market_order(
        ...
        return self._place_market_order_oapg(
            body=body,
