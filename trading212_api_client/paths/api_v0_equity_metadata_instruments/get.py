...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['TradeableInstrument']:
            return TradeableInstrument

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['TradeableInstrument'], typing.List['TradeableInstrument']],
    ...
    def __getitem__(self, i: int) -> 'TradeableInstrument':
