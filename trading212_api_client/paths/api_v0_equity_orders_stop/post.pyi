...
# body param
SchemaForRequestBodyApplicationJson = StopRequest


request_body_stop_request = api_client.RequestBody(
    content={
...
SchemaFor400ResponseBodyApplicationJson = PlaceOrderError
...
class BaseApi(api_client.Api):
    ...
    def _place_stop_order1_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_stop_request.serialize(body, content_type)
...
class PlaceStopOrder1(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def place_stop_order1(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def place_stop_order1(
        ...
        return self._place_stop_order1_oapg(
            body=body,
