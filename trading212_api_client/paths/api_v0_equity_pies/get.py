...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['AccountBucketResultResponse']:
            return AccountBucketResultResponse

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['AccountBucketResultResponse'], typing.List['AccountBucketResultResponse']],
    ...
    def __getitem__(self, i: int) -> 'AccountBucketResultResponse':
