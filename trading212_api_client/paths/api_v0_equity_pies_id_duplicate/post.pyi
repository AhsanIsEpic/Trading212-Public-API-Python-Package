...
from trading212_api_client import api_client, exceptions
...
# body param
SchemaForRequestBodyApplicationJson = DuplicateBucketRequest


request_body_duplicate_bucket_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = AccountBucketInstrumentsDetailedResponse
...
class BaseApi(api_client.Api):
    ...
    def _duplicate_pie_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_duplicate_bucket_request.serialize(body, content_type)
...
class DuplicatePie(BaseApi):
    ...
    def duplicate_pie(
        ...
        return self._duplicate_pie_oapg(
            body=body,
