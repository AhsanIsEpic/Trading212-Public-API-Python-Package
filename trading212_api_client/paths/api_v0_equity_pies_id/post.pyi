...
# body param
SchemaForRequestBodyApplicationJson = PieRequest


request_body_pie_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_pie_request.serialize(body, content_type)
