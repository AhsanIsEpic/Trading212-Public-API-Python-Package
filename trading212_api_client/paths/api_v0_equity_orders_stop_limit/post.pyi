...
# body param
SchemaForRequestBodyApplicationJson = StopLimitRequest


request_body_stop_limit_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _place_stop_order_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_stop_limit_request.serialize(body, content_type)
...
class PlaceStopOrder(BaseApi):
    ...
    def place_stop_order(
        ...
        return self._place_stop_order_oapg(
            body=body,
