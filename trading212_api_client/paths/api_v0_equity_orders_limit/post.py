...
# body param
SchemaForRequestBodyApplicationJson = LimitRequest


request_body_limit_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _place_limit_order_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_limit_request.serialize(body, content_type)
...
class PlaceLimitOrder(BaseApi):
    ...
    def place_limit_order(
        ...
        return self._place_limit_order_oapg(
            body=body,
